...
/* ══════════════════════════════════════════
   ADMIN AUTH
   ══════════════════════════════════════════ */
// Legacy bootstrap password — only used in offline/localStorage mode or before
// the setup wizard sets a real admin password (system/adminAuth). Once a custom
// password is configured, this default is rejected. Change it if you ship the
// template without running setup.html first.
const ADMIN_PW = 'changeme';
