...
function showLogin() {
  ...
  if (nameEl)   nameEl.textContent   = (SITE_SETTINGS && SITE_SETTINGS.siteName)   || 'Dashboard';
  if (studioEl) studioEl.textContent = (SITE_SETTINGS && SITE_SETTINGS.studioName) || 'Your Studio';
